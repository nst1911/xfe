    ...
    DialogBox(win, _("Add To Archive"), DECOR_TITLE | DECOR_BORDER | DECOR_STRETCHABLE | DECOR_MAXIMIZE | DECOR_CLOSE)
{
    ...
    option_tzst = new FXOption(popup, _("tar.zst\tArchive format is tar.zst"), NULL, this, ID_FORMAT_TAR_ZST, JUSTIFY_HZ_APART | ICON_AFTER_TEXT);
    ...
    option_zst = new FXOption(popup, _("zst\tArchive format is zst"), NULL, this, ID_FORMAT_ZST, JUSTIFY_HZ_APART | ICON_AFTER_TEXT);
