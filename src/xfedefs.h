...
#ifndef COPYRIGHT
#define COPYRIGHT    "Copyright (C) 2002-2024 Roland Baudin (roland65@free.fr)"
#endif
...
#define RUN_HIST_SIZE    128
#endif

// Open with history size
#ifndef OPEN_HIST_SIZE
#define OPEN_HIST_SIZE    128
#endif

// Filter history size
#ifndef FILTER_HIST_SIZE
#define FILTER_HIST_SIZE    128
#endif
...
#define DEFAULT_VIDEOPLAYER    "parole"
#endif
