...
FXIcon *bigfolderopenicon, *bigfoldericon, *bigfolderlinkicon, *bigfolderupicon, *bigharddiskicon, *bigiconsicon, *biglinkicon, *bignewfileicon;
...
FXIcon *minifolderlockedicon, *minifolderopenicon, *minifoldericon, *minifolderlinkicon, *minifolderupicon, *minilinkicon;
...
FXbool loadAppIcons(FXApp* app, FXbool *iconpathfound)
{
    *iconpathfound = true;
    ...
    success = ((bigfolderlinkicon = loadiconfile(app, iconpath, "bigfolderlink.png")) != NULL) & success;
    ...
    success = ((minifolderlinkicon = loadiconfile(app, iconpath, "minifolderlink.png")) != NULL) & success;
